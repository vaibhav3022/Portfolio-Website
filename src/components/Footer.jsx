        ...
        <div className="mt-20">
            <div className="text-center">
                <a href="#!">
                    ...
                    <img src="/assets/profile.JPG"  className="w-20 h-20 mx-auto mb-2 dark:block rounded-full object-cover
    border-4 border-purple-500
    shadow-lg shadow-purple-300/50 animate-float" /> 
                   {/* className="w-20 h-20
    rounded-full
    object-cover
    border-4 border-purple-500
    shadow-lg shadow-purple-300/50
    animate-float hidden dark:block" /> */}
                </a>
                ...
                <div className="w-max flex items-center gap-2 mx-auto">
                    ...
                    <a href="mailto:vaibhavdhotre682@gmail.com">vaibhavdhotre682@gmail.com</a>
                </div>
            </div>
            <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-3">
                <p>© {new Date().getFullYear()} <a href="https://github.com/vaibhav3022" target="_blank" rel="noopener noreferrer">Vaibhav Dhotre</a> • MERN Stack Developer • All rights reserved.</p>
                <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
                    <li><a href="https://github.com/vaibhav3022">GitHub</a></li>
                    <li><a href="https://www.linkedin.com/in/vaibhav-dhotre-96b83a224/">LinkedIn</a></li>
                    <li><a href="https://twitter.com/VaibhavDhotre30">Twitter</a></li>
                </ul>
            </div>
        </div>
    )
