export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Mern Stack developer based in Pune.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">I am a Mern Stack  developer from Pune,Maharashtra.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="./assets/Vaibhav-Dhotre.pdf" download
