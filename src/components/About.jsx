    ...
    const data = [
        {
            ...
            description: 'HTML, CSS, Bootstrap, JavaScript,  React Js, NodeJs, ExpressJs,  Next Js , MongoDB',
        },
        {
            name: 'Education',
            icon1: './assets/edu-icon.png',
            icon2: './assets/edu-icon-dark.png',
            description: 'MSC in Computer Application from Savitribai Phule Pune University',
        },
        {
            name: 'Projects',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='./assets/profile.JPG' alt="" className="w-64 sm:w-80 rounded-3xl max-w-none" />

                    <div className="bg-white w-1/2 aspect-square absolute right-0 bottom-0 rounded-full translate-x-1/4 translate-y-1/3 shadow-[0_4px_55px_rgba(149,0,162,0.15)] flex items-center justify-center">
                        <img src="./assets/circular-text.png" alt="" className="w-full animate-spin_slow" />
                        <img src="./assets/dev-icon.jpg" alt="" className="w-1/4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                    </div>
                </div>
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">Aspiring MERN Stack Developer with professional experience as an intern at NDSofttech. Proficient in building dynamic web applications using React, Node.js, and MongoDB, with a passion for delivering efficient, innovative solutions.</p>
