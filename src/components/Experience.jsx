...
export default function Experience() {
  ...
  const experience = [
    ...
    const achievements = [
        {
            ...
            description: "Co-authored paper on 'Analyzing Social Media's Impact on Suicide' at 9th Student Conference, Indira College (2025)",
            icon: "📚"
        },
        {
            title: "Competition Winner",
            description: "First place in LTIMindTree corporate analysis competition on technology consulting",
            icon: "🏆"
        },
        {
            title: "Cultural Excellence",
            description: "Accomplished Pakhawaj player with multiple cultural program performances",
            icon: "🎵"
        }
    ];
    ...
    return (
        <div ref={ref} id="experience" className="w-full px-[12%] py-20 scroll-mt-20 bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-900/30">
            <motion.div
                ...
                <div className="space-y-6">
                    ...
                    >
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="mt-2 sm:mt-0 text-right">
                                <p className="text-sm font-bold text-gray-800 dark:text-white">CGPA: 9.25/10</p>
                                <p className="text-sm text-gray-600 dark:text-gray-400">Aug 2024 - May 2026</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="mt-2 sm:mt-0 text-right">
                                <p className="text-sm font-bold text-gray-800 dark:text-white">CGPA: 7.64/10</p>
                                <p className="text-sm text-gray-600 dark:text-gray-400">June 2021 - May 2024</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
